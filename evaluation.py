...
def simulate_tl_mhp(t_obs, d, episode, timescale, simulator, nodes, trials, quiet=False, stddev=-1, max_events=-1):
    ...
    all_evts = simulator.simulate(episode.entities, episode.timestamps, t_max, trials, quiet, max_events)
